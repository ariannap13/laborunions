...
aggregation = "rolling" # or "rolling" or "all"
...
rolling_emotions = pd.read_csv("../data/rolling_emotions_by_union.csv")
...
df_union.to_csv(f'../data/union_info_bayesian_{aggregation}_window_{rolling_window}_seed{seed}-moredata.csv', index=False)