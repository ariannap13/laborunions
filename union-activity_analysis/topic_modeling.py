...
posts_data_topredict = pd.read_csv("../data/fb_data_with_predictions.csv")

subset_data = posts_data_topredict.copy() # possibly, select a subset of the data
...
topic_model.save("../models/", serialization="safetensors", save_ctfidf=True, save_embedding_model=sentence_model)

info_topics = topic_model.get_topic_info()
# save info
info_topics.to_csv("../data/topic_info_all.csv", index=False)